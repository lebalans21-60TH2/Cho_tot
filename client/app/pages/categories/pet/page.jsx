...
import { homeProducts, DataPet } from '../../../components/Constant/indexData'
import { usePathname, useSearchParams } from 'next/navigation';

const page = () => {
    const pathname = usePathname();
   
    let FilterNormar = DataPet
    // Lọc sản phẩm theo thể loại đồ gia dụng
    // let petData = homeProducts.filter((sp) => sp.category === category);
  ...
  const Datadirections = DataPet[0];
              ...
              <div className="block">
                ...
                <Directions Datadirections={Datadirections} />
                  {/* <div>
                    ...
                    >
                     Mua Bán Chó Mèo, Chim Gà, Phụ Kiện Thú Cưng Khỏe Mạnh Giá Rẻ
                    </h1>
                  </div> */}
                </div>
              </div>
