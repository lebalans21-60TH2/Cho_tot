...
const page = () => {
  // const category = "momandbaby";
  let FilterNormar = DataMomandBaby;
  // Lọc sản phẩm theo thể loại đồ gia dụng
  // let momandbaby = homeProducts.filter((sp) => sp.category === category);

  // const DataProducts = momandbaby;
    // test phần filter
    const [products, setProducts] = useState([]);
    const [filteredProducts, setFilteredProducts] = useState([]);
    const [categorySub, setCategorySub] = useState("");
  const [category, setCategory] = useState("momandbaby");
  const Datadirections = DataMomandBaby[0];
