...
const page = () => {
  ...
  // const category = "house-ware";
  let FilterNormar = DataCategoryHouseWare;
  // Lọc sản phẩm theo thể loại đồ gia dụng
  // let housewareProduct = homeProducts.filter((sp) => sp.category === category);
  // const DataProducts = housewareProduct;
  const Datadirections = DataCategoryHouseWare[0];

  // test phần filter
  const [products, setProducts] = useState([]);
  const [filteredProducts, setFilteredProducts] = useState([]);
  const [categorySub, setCategorySub] = useState("");
  const [category, setCategory] = useState("house-ware");
