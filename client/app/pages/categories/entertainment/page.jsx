...
// Import data product
import { homeProducts,DataCategoryEntertainment } from "../../../components/Constant/indexData";

// lay router cua trang
import { usePathname, useSearchParams } from "next/navigation";
import PostFromPartners from '../../../components/Products/PostingsFromPartners/PostFromPartners'

const page = () => {
  const pathname = usePathname();
  // const category = 'entertainnment'
  let FilterNormar = DataCategoryEntertainment
  // Lọc sản phẩm theo thể loại đồ gia dụng
  // let entertainmentProduct = homeProducts.filter(sp => sp.category === category);

  const Datadirections = DataCategoryEntertainment[0];
  // const DataProducts = entertainmentProduct

    // test phần filter
    const [products, setProducts] = useState([]);
    const [filteredProducts, setFilteredProducts] = useState([]);
    const [categorySub, setCategorySub] = useState("");
    const [category, setCategory] = useState("entertainnment");
      ...
      <div className="hidden 800px:w-full bg-[#f4f4f4] 800px:flex 800px:flex-col">
        ...
        >
          ...
          <div>
            ...
            {DataCategoryEntertainment[0].Title}
            </h1>
          </div>
          {/*Phaanf main  */}
          <div className="float-left w-full ">
            <div className="max-w-[66.666%] p-0 ">
              ...
              {/* Tin dang tu doi tac cho tot */}
              <div className="min-h-[unset] w-full inline-block bg-[#fff] mb-[-4px] mt-[4px]">
              <PostFromPartners category={category} />
              </div>
            </div>
          </div>
          {/* So trang */}
