...
// Import data product
import { homeProducts, DataHouseholdElectrical } from "../../../components/Constant/indexData";
...
const page = () => {
    ...
    // const category = "householdElectrical";
    let FilterNormar = DataHouseholdElectrical
    // Lọc sản phẩm theo thể loại đồ gia dụng
    // let householdElectrical = homeProducts.filter((sp) => sp.category === category);
    // const DataProducts = householdElectrical;
    const Datadirections = DataHouseholdElectrical[0];
  ...
  const [category, setCategory] = useState("householdElectrical");
    ...
    <div className="hidden 800px:w-full bg-[#f4f4f4] 800px:flex 800px:flex-col">
      ...
      >
        ...
        <div>
          ...
          {DataHouseholdElectrical[0].Title}
          </h1>
        </div>
        {/*Phaanf main  */}
