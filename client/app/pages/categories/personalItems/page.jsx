...
// Import data product
import { homeProducts, DataPersonalItems } from "../../../components/Constant/indexData";
...
const page = () => {
    ...
    // const category = "personalItems";
    let FilterNormar = DataPersonalItems
    // Lọc sản phẩm theo thể loại đồ gia dụng
    // let personalItems = homeProducts.filter((sp) => sp.category === category);
    // const DataProducts = personalItems;
    const Datadirections = DataPersonalItems[0];
  ...
  const [category, setCategory] = useState("personalItems");
