...
const Suggestions = () => {
                  ...
                  {sugetionsproduct?.map((sugetionsproduct) => (
                    <SwiperSlide>
                      <div
                        ...
                        className="overflow-hidden bg-white border-[2px] border-[#d8d8d8] basis-[20%] p-3 w-[200px] min-w-[200px] transition-transform duration-300 ease-in-out hover:shadow-lbl mt-1 mb-[1px]"
                      >
  ...
  {/* Reponsive */}
  <div className="flex justify-center bg-[#F4F4F4] 800px:hidden">
    <div className="w-full max-w-[1024px] bg-[#F4F4F4] pb-4 mt-3 ">
      <div className="mr-auto ml-auto h-[auto] p-0">
